...
class AbstractImage(object):
    ...
    def saveTk(self,fname=None,ftype='gif'):
        ...
        try:
            ...
            print("Error saving tk, Could Not open ", fname, " to write.", str(e))
...
if __name__ == '__main__':
    win = ImageWin("My Window",512,750)
    oImage = FileImage('vh.gif')
...
#             x = map(lambda x: 255-x, v)
    ...
    myImage.setPosition(0,myImage.getHeight()+1)
    myImage.draw(win)
    print(win.getMouse())
    myImage.save('testfoo.gif')
